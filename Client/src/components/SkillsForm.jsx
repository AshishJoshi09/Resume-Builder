  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input type="text" placeholder='Enter a skill(e.g JavaScript, Java, Project Management)' className='flex-1 px-3 py-2 text-sm' onChange={(e)=> setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}/>
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'> <strong> Tip: </strong> Add relevant skills. Include both technical skills (programming, language, tools) and soft skills (leadership, communication).</p>
        </div>
