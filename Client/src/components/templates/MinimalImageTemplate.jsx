            ...
            <div className="grid grid-cols-3">
                ...
                <div className="col-span-1  py-10">
                    ...
                    {data.personal_info?.image && typeof data.personal_info.image === 'string' ? (
                        <div className="mb-6">
                            <img src={data.personal_info.image} alt="Profile" className="w-32 h-32 rounded-full mx-auto object-cover aspect-square" style={{ background: accentColor+'70' }} />
                        </div>
                    ) : (
                        data.personal_info?.image && typeof data.personal_info.image === 'object' ? (
                            <div className="mb-6">
                                <img src={URL.createObjectURL(data.personal_info.image)} alt="Profile" className="w-32 h-32 rounded-full mx-auto object-cover aspect-square" />
                            </div>
                        ) : null
                    )}
                </div>
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            {data.personal_info?.linkedin && (
                                <a target="_blank" href={data.personal_info?.linkedin} className="flex items-center gap-2">
                                    <FaLinkedin size={16} style={{ color: accentColor }} />
